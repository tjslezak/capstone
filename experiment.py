...
from geotoolkit import build_class_color_dict, get_tile_ids, tile_train_test_split
...
class GeoSemanticSegmentation(rv.ExperimentSet):
    def exp_main(self, root_uri, data_uri, test_run=False):
        ...
        Uses Tensorflow Deeplab backend with XCEPTION65 architecture.
        Args:
        ...
        train_ids, val_ids = tile_train_test_split(tile_ids, val_ids)
        ...
        backend = rv.BackendConfig.builder(rv.TF_DEEPLAB) \
                                  ...
                                  .with_train_options(sync_interval=1800) \
